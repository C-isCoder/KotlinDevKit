package com.baichang.android.library.kotlin.widget.photoGallery;
...
import com.baichang.android.kotlin.width.photoView.PhotoView;
import com.baichang.android.kotlin.width.photoView.PhotoViewAttacher;
...
public class PhotoGalleryFragment extends Fragment
    ...
    private View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        Glide.with(getActivity())
            .asBitmap()
            .load(
                isFullPath ? imageUrl : Configuration.Companion.get().getApiLoadImage() + imageUrl)
